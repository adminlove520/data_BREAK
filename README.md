...
> data_BREAK 由东方隐侠.Anonymous创建、拥有和进行管理。东方隐侠.Anonymous是专注于挖掘和解决企业安全运行风险隐患的专业型红队。东方隐侠.Anonymous保留自行决定定期更新 BREAK 和本文档的权利。虽然东方隐侠.Anonymous拥有 BREAK 的所有权利和利益，但它许可公众自由使用，遵循相关开源协议。
